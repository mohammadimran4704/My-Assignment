jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        transition:"slice,blocks,elastic,threedflipwithzoom,threedwithzoom,threedflip,cssslide,threedtiles,slide,crossfade,threedhorizontalwithzoom,fade,threedhorizontal,blinds,threed",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
